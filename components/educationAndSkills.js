    ...
    <div className="p-10">
      <div className="flex flex-col lg:flex-row items-start justify-between">
        ...
        <div className="w-full lg:w-1/2 pr-0 lg:pr-8 mb-10 lg:mb-0">
          ...
          <div className="space-y-6">
            <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <p className="text-gray-600">International Design Institute</p>
            </div>
            <div className="bg-gray-100 p-4 rounded-lg">
              <div className="bg-green-500 text-white rounded-full w-max px-3 py-1 mb-2">
                2010-2012
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-gray-600 mb-1">HTML5</label>
            ...
            <div>
              <label className="block text-gray-600 mb-1">WordPress</label>
              <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
                <div
                  className="bg-green-500 h-2.5 rounded-full"
                  style={{ width: "80%" }}
            ...
            <div>
              <label className="block text-gray-600 mb-1">Magento</label>
              <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
                <div
                  className="bg-green-500 h-2.5 rounded-full"
                  style={{ width: "70%" }}
            ...
            <div>
              <label className="block text-gray-600 mb-1">UI/UX</label>
              <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
                <div
                  className="bg-green-500 h-2.5 rounded-full"
                  style={{ width: "85%" }}
